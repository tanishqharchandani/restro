...
main.title("Resturant Management System")
main.resizable(0, 0)
def Exit():
...
button1 = Button(main)
button1.place(relx=0.800, rely=0.080, width=100, height=70)
...
button2 = Button(main)
button2.place(relx=0.900, rely=0.080, width=100, height=70)
...
button3 = Button(main)
button3.place(relx=0.316, rely=0.446, width=146, height=90)
...
button3.configure(image=img2)
button3.configure(command=emp)
